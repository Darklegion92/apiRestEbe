...
public interface IPerecederosDao extends CrudRepository<Articulo, Long> {
	...
	@Query(value = "select a.arti_cod as codigo ,ajd.ajus_exnue as invinicial "
	...
	public List<Ajuste> find(Date fecha, Integer idsucursal, Integer idfamilia);
